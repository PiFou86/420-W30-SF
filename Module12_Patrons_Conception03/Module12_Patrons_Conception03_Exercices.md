...
- Créez la classe "TraitementImageSeuilLuminance" qui effectue un seuil par rapport à la valeur de la luminance du pixel traité. Cette classe hérite de "TraitementImageMasque". Copiez-y la méthode suivante :
